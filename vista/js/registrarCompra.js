...
let totalCompra=document.getElementById("total_compra")
...
id_linea_1.addEventListener("keyup", ()=>{
    ...
    totalCompra.value=Number(subtotal_linea_1.value) + Number(subtotal_linea_2.value) + Number(subtotal_linea_3.value);
})
