...
$descripcion_articulo_1 = substr($articulo_linea_1, $posicion_separacion_1 + 3, $posicion_separacion_2 - 3);//Obteniendo la descripción
...
$descripcion_articulo_2 = substr($articulo_linea_2, $posicion_separacion_1 + 3, $posicion_separacion_2 - 3);//Obteniendo la descripción
...
$descripcion_articulo_3 = substr($articulo_linea_3, $posicion_separacion_1 + 3, $posicion_separacion_2 - 3);//Obteniendo la descripción
